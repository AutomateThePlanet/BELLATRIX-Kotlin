...
//        val touchAction: TouchAction = TouchAction(DriverService.getWrappedIOSDriver())
...
//        val touchAction: TouchAction<*> = TouchAction<Any?>(DriverService.getWrappedIOSDriver())
