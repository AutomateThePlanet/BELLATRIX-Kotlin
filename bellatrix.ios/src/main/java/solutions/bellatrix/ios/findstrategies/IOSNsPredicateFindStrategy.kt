...
class IOSNsPredicateFindStrategy(value: String) : FindStrategy(value) {
    override fun findElement(driver: IOSDriver<MobileElement>): MobileElement {
        return driver.findElementByIosNsPredicate(value)
    }

    override fun findAllElements(driver: IOSDriver<MobileElement>): List<MobileElement> {
        return driver.findElementsByIosNsPredicate(value)
    }

    override fun findElement(element: MobileElement): MobileElement {
        // IOSNsPredicateFindStrategy not supported for searching inside another element.
    ...
    override fun toString(): String {
        return String.format("IOSNsPredicate = %s", value)
    }
}