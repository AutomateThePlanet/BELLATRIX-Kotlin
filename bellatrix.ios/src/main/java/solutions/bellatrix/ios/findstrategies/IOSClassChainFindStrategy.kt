...
class IOSClassChainFindStrategy(value: String?) : FindStrategy(value!!) {
    override fun findElement(driver: IOSDriver<MobileElement>): MobileElement {
        return driver.findElementByIosClassChain(value)
    }

    override fun findAllElements(driver: IOSDriver<MobileElement>): List<MobileElement> {
        return driver.findElementsByIosClassChain(value)
    }
    ...
    override fun toString(): String {
        return String.format("IosClassChain = %s", value)
    }
}