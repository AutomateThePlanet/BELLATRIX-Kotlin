...
class DescriptionFindStrategy(value: String) : FindStrategy(value) {
    private val DESCRIPTION_EXPRESSION = "new UiScrollable(new UiSelector()).scrollIntoView(new UiSelector().description(\\\"%s\\\"));"
    ...
    override fun toString(): String {
        return String.format("description = %s", value)
    }
}