...
class AndroidUIAutomatorFindStrategy(value: String) : FindStrategy(value) {
    override fun findElement(driver: AndroidDriver<MobileElement>): MobileElement {
        return driver.findElementByAndroidUIAutomator(value)
    }

    override fun findAllElements(driver: AndroidDriver<MobileElement>): List<MobileElement> {
        return driver.findElementsByAndroidUIAutomator(value)
    }
    ...
    override fun toString(): String {
        return String.format("androidUIAutomator = %s", value)
    }
}